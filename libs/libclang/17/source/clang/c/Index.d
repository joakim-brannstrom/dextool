...
public import clang.c.CXDiagnostic;
public import clang.c.CXErrorCode;
public import clang.c.CXFile;
...
struct CXIndexOptions
{
     ...
     */
    ubyte ThreadBackgroundPriorityForIndexing;
    /**
     * A CXChoice enumerator that specifies the editing priority policy.
     * \sa CXGlobalOpt_ThreadBackgroundPriorityForEditing
     */
    ubyte ThreadBackgroundPriorityForEditing;

    mixin(bitfields!(
        uint, "ExcludeDeclarationsFromPCH", 1,
        uint, "DisplayDiagnostics", 1,
        uint, "StorePreamblesInMemory", 1,
        uint, "", 13));
 ...
 */
uint clang_CXXMethod_isDeleted(CXCursor C);
 ...
 * Is not.
 */
uint clang_CXXMethod_isCopyAssignmentOperator(CXCursor C);
 ...
 * Is not.
 */
uint clang_CXXMethod_isMoveAssignmentOperator(CXCursor C);
 ...
 */
uint clang_CXXMethod_isExplicit(CXCursor C);
 ...
 */
CXString clang_getBinaryOperatorKindSpelling(CXBinaryOperatorKind kind);
 ...
 */
CXBinaryOperatorKind clang_getCursorBinaryOperatorKind(CXCursor cursor);
 ...
 */
CXString clang_getUnaryOperatorKindSpelling(CXUnaryOperatorKind kind);
 ...
 */
CXUnaryOperatorKind clang_getCursorUnaryOperatorKind(CXCursor cursor);

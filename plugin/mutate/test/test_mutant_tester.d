...
", program_cpp, program_bin));
    ...
    File(test_script, "w").write(scriptSimulatingComplextGTestSuite);
...
", program_cpp, program_bin));
    ...
    File(test_script, "w").write(scriptSimulatingComplextCTestSuite);
...
immutable scriptSimulatingComplextGTestSuite =
"#!/bin/bash
cat <<EOF
...
immutable scriptGTestSuitePassed =
"#!/bin/bash
cat <<EOF
Running main() from gtest_main.cc

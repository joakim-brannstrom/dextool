...
void main(string[] args) {
    ...
    string[] chapters = [
        "overview.md", "use_cases.md", "security.md", "mutations.md",
        "analyzer/analyzer.md", "test_mutant/basis.md",
        "test_mutant/pull_request.md", "test_mutant/tracker.md",
        "test_mutant/coverage.md", "usability/sanity_check.md",
        "usability/report.md", "usability/sanity_check.md"
    ];

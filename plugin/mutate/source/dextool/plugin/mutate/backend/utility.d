...
class ProfileResults {
    ...
    override string toString() const {
        ...
        const wallMaxLen = results.byValue.map!(a => a.total!"seconds").maxElement + 15;
...
struct Profile {
    ...
    this(T)(T name, ProfileResults saveTo = null, string module_ = __MODULE__) @safe nothrow {
        try {
            this.name = module_ ~ "." ~ name.to!string;
        } catch (Exception e) {

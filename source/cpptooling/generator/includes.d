...
import application.types : DextoolVersion, FileName;
...
/// Create a header
auto makeHeader(FileName fname, DextoolVersion ver) {
    import std.path : baseName;
    import dsrcgen.cpp : CppModule;

    auto m = new CppModule;
    m.comment("@file " ~ fname.baseName)[$.begin = "/// "];
    m.comment("@brief Generated by dextool version " ~ ver)[$.begin = "/// "];
